...
| A3 | [Signals, notes, and type-specific rendering](A3-signals-and-notes.md) | **Ready for review; not approved** | Readable-layer restructure, note templates, and the notebook fixture corpus |
